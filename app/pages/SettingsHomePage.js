...
export function SettingsHomePage({ navigation }) {
  const settingsHomePageOperations = new SettingsHomePageOperations(
    auth.currentUser
  );
      ...
      <Card>
        ...
        >
          ...
          <ChevronButton
            ...
            isDisabled={
              !settingsHomePageOperations.isChangePasswordAccessable()
            }
        ...
        >
          <PrimaryButton
            text="Logout"
            isDisabled={!settingsHomePageOperations.isLogoutActive()}
          />
          <PrimaryButton
            text="Delete Account"
...
function ChevronButton({ text, isDisabled, onPress }) {
  return (
    ...
    >
      ...
      >
        <Text style={{ color: isDisabled ? "lightgrey" : "black" }}>
          {text}
        </Text>
