    ...
    <View style={{ position: "relative", display: "flex", alignItems: "center", width: "100%", height: "100%", paddingTop: 30 }}>
      ...
      <Card>
        ...
        <View style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "100%", paddingHorizontal: 20}}>
          ...
          <PrimaryButton text="Delete Account" isDisabled={!settingsHomePageOperations.isDeleteAccountActive()} />
        </View>
      </Card>
    </View>
  );
  ...
  return (
    ...
    >
      <View style={{ display: "flex", flexDirection: "row", width: "100%", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <MaterialCommunityIcons name="chevron-right" size={30} style={{ color: isDisabled ? "lightgrey" : "black" }} />
      </View>
    </TouchableOpacity>
  );
}
...
function PrimaryButton({ text, isDisabled, onPress }) {
  return (
    <TouchableOpacity activeOpacity='0.5'
      {...isDisabled ? { activeOpacity: '0.5', disabled: true } : {}}
      onPress={() => !isDisabled && onPress && onPress()}
      style={{ width: "60%", backgroundColor: isDisabled ? "lightgrey" : colors.tertiary, paddingTop: 10, paddingRight: 20, paddingBottom: 10, paddingLeft: 20, borderRadius: 10, marginBottom: 10 }}
    >
