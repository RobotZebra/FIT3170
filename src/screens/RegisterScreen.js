...
const RegisterScreen = ({ navigation }) => {
  ...
  const handleUserSignUp = () => {
    if (
      ...
      errorCheck.familyName ||
      errorCheck.password ||
      errorCheck.pregnancyStatus
    ) {
      ...
      if (inputs[field] == '') {
        ...
        if (field == 'firstName' || field == 'familyName') {
          setErrorCheck((prevState) => ({
            ...prevState,
            [field]: !/^[a-zA-Z]+$/.test(inputs[field]),
          }));
        }
        ...
        // check if email is correct
          ...
          setErrorCheck((prevState) => ({
            ...prevState,
            [field]: !emailRegex.test(inputs[field]),
          }));
        }
        // all other cases
        else {
      ...
      <View style={styles.pageStyling}>
        ...
        <View style={styles.modalWindow}>
          ...
          <TextInput
            ...
            style={
              errorCheck.firstName
                ? [styles.modalField, styles.firstNameField, styles.errorField]
                : [styles.modalField, styles.firstNameField]
            }
            textContentType="givenName"
            onChangeText={(text) => {
              getUserInput(text, 'firstName');
            }}
          />
          <TextInput
            ...
            style={
              errorCheck.familyName
                ? [styles.modalField, styles.lastNameField, styles.errorField]
                : [styles.modalField, styles.lastNameField]
            }
            textContentType="familyName"
            onChangeText={(text) => {
              getUserInput(text, 'familyName');
            }}
          />
          <TextInput
            placeholder="Email"
            ...
            style={
              errorCheck.email
                ? [styles.modalField, styles.emailField, styles.errorField]
                : [styles.modalField, styles.emailField]
            }
          ...
          <TextInput
            ...
            style={
              errorCheck.password
                ? [styles.modalField, styles.passwordField, styles.errorField]
                : [styles.modalField, styles.passwordField]
            }
            autoCapitalize="none"
          ...
          <DropDownPicker
            ...
            style={
              errorCheck.pregnancyStatus
                ? [styles.modalField, styles.modalPregDropdown, styles.errorField]
                : [styles.modalField, styles.modalPregDropdown]
            }
            ...
            onChangeValue={(item) => {
              getUserInput(item, 'pregnancyStatus');
            }}
          />
          ...
          <TouchableOpacity
            ...
            {typeof date == 'string' ? (
              <Text style={{ color: 'grey', flex: 0.8, marginLeft: -vw(1) }}> {date} </Text>
            ) : (
              <Text style={{ color: 'black', flex: 0.8 }}>{date.toDateString()}</Text>
            )}
        ...
        <View>
          <Text style={styles.oldUserInfo}>Already have an account?</Text>
          <TouchableOpacity
